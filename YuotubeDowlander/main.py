...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.std_download_path = str(os.path.join(os.path.expanduser("~"), "İndirilenler"))
    ...
    def initUI(self):
        ...
        self.input_url.setPlaceholderText("URL'yi Buraya Girin...")
